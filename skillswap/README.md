# 🚀 SkillSwap — Platform Barter Skill #1 Antar Mahasiswa Indonesia
...
- **Backend Architecture**: Node.js & REST API / Socket.io
...
# 4. Jalankan mode pengembang (development server)
npm run dev
```
...
- **GitHub Repository**: [https://github.com/DevIssa-It/skillswap.git](https://github.com/DevIssa-It/skillswap.git)
